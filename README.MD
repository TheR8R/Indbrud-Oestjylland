...
- **[Leaflet.js](https://leafletjs.com/)** — Interactive map library - only needed for local development
- **[Leaflet.markercluster](https://github.com/Leaflet/Leaflet.markercluster)** — Marker clustering plugin, only needed for local development
...
```json
{
  "lastUpdated": "2026-01-20T08:34:40.886Z",
  "data": {
    "2026-01-09": {
      "Østjyllands Politi": {
        "Skødstrup": [
...
| Field | Description |
|-------|-------------|
| `lastUpdated` | ISO timestamp of when the data was last sanitized |
| `data` | Object containing all incident data, keyed by date |
...
- A lot of adresses are geocoded wrong, and therefore some pins location may not be accurate (work in progress)
