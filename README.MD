...
Scraper and visualization tool for break-in (indbrud) reports from Østjyllands Politi's daily reports (døgnrapporter).
...
│       └── saveFile.js   # Shared saving and loading file utilities
├── data/
